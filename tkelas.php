...
$query = mysqli_query($koneksi, "SELECT max(id) as kodeTerbesar FROM kelas");
...
if (isset($_POST["submit"])) {
    if (tambah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'dkelas.php';
        </script>
        ";
    } else {
        echo "
        <script>
            ...
            document.location.href = 'tkelas.php';
        </script>
        ";
    }
}
...
<div class="row no-gutters mt-4 ">
	<div class="col-md-2 bg-dark pr-4 pt-3">
		<ul class="nav flex-column ml-3 mb-5 px-3 mt-4">
		  ...
		  <li class="nav-item">
		  	<a class="nav-link active text-white" aria-current="page" href="pertemuan.php">Pertemuan</a>
		  	<hr class="bg-light">
		  </li>
		  <li class="nav-item">
	...
	<div class="col-md-10 p-5 pt-5">
		<h3>Tambah Kelas</h3><hr>
		<form method="post" action="" class="pt-3" style="width: 50%; font-weight: bold">
		  <div class="mb-3 " >
		    <label class="form-label">ID</label>
		    <input type="text" class="form-control" name="id" required="required" value="<?php echo $kodeBarang ?>" readonly>
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Kode Kelas</label>
		    <input type="text" class="form-control" name="kode_kelas" placeholder="Masukkan Kode Kelas" required="required">
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Kode Matakuliah</label>
		    <input type="text" class="form-control" name="kode_makul" placeholder="Masukkan Kode Matakuliah" required="required">
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Nama Matakuliah</label>
		    <input type="text" class="form-control" name="nama_makul" placeholder="Masukkan Nama Matakuliah" required="required">
		  </div>
		  <div class="mb-3">
		  ...
		  <div class="mb-3">
		    ...
		    <select name="sks" class="form-control" required="required">
			<option >1</option>
			<option >2</option>
			<option >3</option>
			<option >4</option>
