...
require 'koneksi.php';
$id = $_GET["id"];
$data = query("SELECT * FROM kelas WHERE id = '$id'")[0];
if (isset($_POST["submit"])) {
    if (ubah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'ukelas.php';
        </script>
        ";
    }
}
	...
	<div class="col-md-10 p-5 pt-5">
		...
		<form method="post" action="" class="pt-3" style="width: 50%; font-weight: bold">
		  <div class="mb-3 " >
		    ...
		    <input type="text" class="form-control" name="id" required="required" value="<?= $data["id"]; ?>" readonly>
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Kode Kelas</label>
		    <input type="text" class="form-control" name="kode_kelas" required="required" value="<?= $data["kode_kelas"]; ?>">
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Kode Matakuliah</label>
		    <input type="text" class="form-control" name="kode_makul" required="required" value="<?= $data["kode_makul"]; ?>">
		  </div>
		  <div class="mb-3">
		    <label class="form-label">Nama Matakuliah</label>
		    <input type="text" class="form-control" name="nama_makul" required="required" value="<?= $data["nama_makul"]; ?>">
		  </div>
		  <div class="mb-3">
